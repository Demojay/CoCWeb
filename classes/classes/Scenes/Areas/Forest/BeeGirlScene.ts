    ...
    */
    ...
    private beeAlternate(): void {
        ...
        if (BeeGirlScene.rand(2) == 0) {
            ...
            //Catchall scenario
            if (this.player.cocks[x].cockType == CockTypesEnum.DEMON || this.player.cocks[x].cockType > 4) this.outputText("You loosen your " + this.player.armorName + " and unleash your cocks.  The glans of the largest is already drooling pre as you enjoy the sight of the helpless, squirming bee-girl.  Guiding it forwards, you spank her ass, making the girl yelp and leaving trails of sticky pre across the globes of her ass.  Grinning, you drag your shaft back and forth across her pussy, slicking it in her honey.  Finally, you press the tip against her opening.  She's a tight fit for you, and she squeals more loudly as your shaft spreads her little cunny inexorably.  ", false);
            //CONTINUE
